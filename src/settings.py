...
class AppSettings:
    ...
    skip_challenge_texts: List[str] = field(default_factory=lambda: [
        ...
        "foco gera resultado",
        "hoje conta mais",
        "menos conversa mais acao",
        "nao desperdice tempo",
        "consistencia e poder",
        "o esforco compensa",
        "termine antes de parar",
        "priorize o essencial",
        "acao supera planejamento",
        "compromisso com excelencia",
        "tempo nao volta",
        "entregue com qualidade",
        "faca acontecer agora",
        "sem atalhos hoje",
        "resultados exigem constancia",
        "proteja seu foco",
        "avance sem desculpas",
        "a meta e clara",
    ])
